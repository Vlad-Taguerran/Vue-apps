...
type AccontConnection {
  pageInfo: PageInfo!
  edges: [AccontEdge]!
  aggregate: AggregateAccont!
}

input AccontCreateInput {
  user: UserCreateOneInput
  description: String!
}

input AccontCreateOneInput {
...
type AccontPreviousValues {
  id: ID!
  description: String!
}

type AccontSubscriptionPayload {
...
input AccontSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: AccontWhereInput
  AND: [AccontSubscriptionWhereInput!]
  OR: [AccontSubscriptionWhereInput!]
  NOT: [AccontSubscriptionWhereInput!]
}

input AccontUpdateDataInput {
  user: UserUpdateOneInput
  description: String
}

input AccontUpdateInput {
  user: UserUpdateOneInput
  description: String
}

input AccontUpdateManyMutationInput {
  description: String
}

input AccontUpdateOneRequiredInput {
  create: AccontCreateInput
...
input AccontUpsertNestedInput {
  update: AccontUpdateDataInput!
  create: AccontCreateInput!
}

input AccontWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  AND: [AccontWhereInput!]
  OR: [AccontWhereInput!]
  NOT: [AccontWhereInput!]
}

input AccontWhereUniqueInput {
  id: ID
}

type AggregateAccont {
  count: Int!
}
...
input CategoryWhereInput {
  ...
  descripition_in: [String!]
  descripition_not_in: [String!]
...
type Mutation {
  createAccont(data: AccontCreateInput!): Accont!
  updateAccont(data: AccontUpdateInput!, where: AccontWhereUniqueInput!): Accont
  updateManyAcconts(data: AccontUpdateManyMutationInput!, where: AccontWhereInput): BatchPayload!
  upsertAccont(where: AccontWhereUniqueInput!, create: AccontCreateInput!, update: AccontUpdateInput!): Accont!
  deleteAccont(where: AccontWhereUniqueInput!): Accont
  deleteManyAcconts(where: AccontWhereInput): BatchPayload!
...
type Query {
  accont(where: AccontWhereUniqueInput!): Accont
  acconts(where: AccontWhereInput, orderBy: AccontOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Accont]!
  accontsConnection(where: AccontWhereInput, orderBy: AccontOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): AccontConnection!
...
type Subscription {
  accont(where: AccontSubscriptionWhereInput): AccontSubscriptionPayload
